  ...
  const handleChange = async (e) => {
    if (e.target.checked) {
      ...
      try {
        ...
        // After animations complete (3.5s), the component will show "Open"
      } catch (error) {
      ...
      // Handle open when clicking after completion
      if (fileUrlRef.current) {
        window.open(fileUrlRef.current, "_blank");
        // Reset after opening
        setTimeout(() => {
          if (checkboxRef.current) {
            checkboxRef.current.checked = false;
    ...
    <StyledWrapper>
      <div className="container">
        <label className="label">
          ...
          <p className="title flex justify-center items-center -translate-x-1">Resume</p>
