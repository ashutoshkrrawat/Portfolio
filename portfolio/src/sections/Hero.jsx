      ...
      <div className="max-w-6xl mx-auto w-full flex flex-col items-center text-center gap-12 relative">
        ...
        <div className="flex justify-center select-none whitespace-nowrap">
          <div className="flex items-center gap-3">
            <WordRotate
              ...
              className="font-doto-rounded text-[4vw] text-white"
            />
        ...
        <div className="max-w-3xl">
          <p className="text-lg md:text-xl text-white/70 mb-6">
            Hi, I am{" "}
            <span className="font-bold text-white">ASHUTOSH</span>
            <br />
            Welcome to my{" "}
            <span className="font-outfit font-[700] text-white">
              portfolio
            </span>
          </p>
